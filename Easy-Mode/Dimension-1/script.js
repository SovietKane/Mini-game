...
function cookieClick() { 
    ...
    if(num >= 100000000000000000000000000000000000000){
        num >= 1000000000000000000000000000000000000
        upgradeLevel.innerHTML = "Illuminato V"
    }
    if(num >= 100000000000000000000000000000000000000000){
